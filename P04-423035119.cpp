...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/////////////////////////////// GRUA /////////////////////////////////////////
		////////// TECLAS GRUA (F,G,H,J) RUEDAS (V,B,N,M) 
			...
			//rueda 1
			base = model;
			model = glm::translate(model, glm::vec3(-0.5f, -0.7f, 0.65f));
			...
			////glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
			////glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
			////color = glm::vec3(1.0f, 0.70f, 0.50f);
			////glUniform3fv(uniformColor, 1, glm::value_ptr(color));
			////meshList[0]->RenderMesh();
			////model = modelaux;
			...
			////model = glm::scale(model, glm::vec3(0.5f, 0.1f, 2.0f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			...
			//////articulacion 1 
			////model = glm::translate(model, glm::vec3(-3.0f, 0.0f, 1.2f));
			////model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, -1.0f));
			////modelaux = model;
			////model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			...
			////model = glm::scale(model, glm::vec3(1.0f, 2.8f, 0.8f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			////color = glm::vec3(1.0f, 0.70f, 0.50f);
			////glUniform3fv(uniformColor, 1, glm::value_ptr(color));
			////meshList[0]->RenderMesh();
			...
			////model = glm::scale(model, glm::vec3(1.2f, 0.8f, 0.8f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			////color = glm::vec3(1.0f, 1.0f, 1.0f);
			////glUniform3fv(uniformColor, 1, glm::value_ptr(color));
			////meshList[0]->RenderMesh();
			...
			////// cara
			////model = base;
			////model = glm::translate(model, glm::vec3(-4.8f, 0.5f, 0.0f));
			////cara = model;
			////modelaux = model;
			...
			////// boca
			////modelaux = model;
			////model = glm::translate(model, glm::vec3(-1.15f, -0.5f, 0.0f));
			...
			//////nariz
			////modelaux = model;
			////model = glm::translate(model, glm::vec3(-1.3f, -0.35f, 0.0f));
			////model = glm::scale(model, glm::vec3(0.2f, 0.4f, 0.4f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			////color = glm::vec3(0.9f, 0.2f, 0.7f);
			////glUniform3fv(uniformColor, 1, glm::value_ptr(color));
			////meshList[0]->RenderMesh();
			////model = modelaux;
			...
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			////color = glm::vec3(1.0f, 0.8f, 0.50f);
			////glUniform3fv(uniformColor, 1, glm::value_ptr(color));
			////meshList[0]->RenderMesh();
			////model = modelaux;
			...
			////// ojo 
			////model = glm::translate(model, glm::vec3(-0.75f, 0.5f, 0.65f));
			////modelaux = model;
			////model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			////color = glm::vec3(1.0f, 1.0f, 1.0f);
			...
			////model = modelaux;
			////modelaux = model;
			////model = glm::translate(model, glm::vec3(-0.01f, 0.0f, -0.3f));
			////model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.4f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			...
			////model = glm::rotate(model, glm::radians(mainWindow.getarticulacion11()+40), glm::vec3(1.0f, 0.0f, 0.0f));
			////modelaux = model;
			...
			////modelaux = model;
			////model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			////model = glm::scale(model, glm::vec3(3.5f, 0.5f, 0.5f));
			////glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			////color = glm::vec3(1.0f, 0.70f, 0.50f);
			////glUniform3fv(uniformColor, 1, glm::value_ptr(color));
			////meshList[0]->RenderMesh();
