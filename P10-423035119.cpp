...
void saveFrame(void) //tecla L
{
	...
	KeyFrame[FrameIndex].giroAlas = giroAlas;
...
int main()
{
	...
	Ala_M2 = Model();
	Ala_M2.LoadModel("Models/ala2.obj");
	...
	printf("3.-Presiona L para guardar frame\n4.-Presiona P para habilitar guardar nuevo frame\n5.-Presiona 1 para mover en X positivo \n");
	printf("6.-Presiona 2 para mover en X negativo \n");
	printf("7.-Presiona 3 para mover en Y postivo \n");
	printf("8.-Presiona 4 para mover en Y negativo \n");
	printf("9.-Presiona 5 para girar avion \n");
	printf("10.-Presiona 6 para poner a las 45 grados \n");
	printf("11.-Presiona 7 para poner a las 0 grados\n");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, (giroAlas)*toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
...
void inputKeyframes(bool* keys)
{
	...
	if (keys[GLFW_KEY_1] && !keyPressed[GLFW_KEY_1])
	{
		movAvion_x += 1.0f;
		printf("movAvion_x es: %f\n", movAvion_x);
	...
	if (keys[GLFW_KEY_2] && !keyPressed[GLFW_KEY_2])
	{
		movAvion_x -= 1.0f;
		printf("movAvion_x es: %f\n", movAvion_x);
	...
	if (keys[GLFW_KEY_3] && !keyPressed[GLFW_KEY_3])
	{
		movAvion_y += 1.0f;
		printf("movAvion_y es: %f\n", movAvion_y);
	...
	if (keys[GLFW_KEY_4] && !keyPressed[GLFW_KEY_4])
	{
		movAvion_y -= 1.0f;
		printf("movAvion_y es: %f\n", movAvion_y);
	...
	if (keys[GLFW_KEY_5] && !keyPressed[GLFW_KEY_5])
	{
		giroAvion += 90.0f;
	...
	if (!keys[GLFW_KEY_5])
	{
		keyPressed[GLFW_KEY_5] = false;
	}

	if (keys[GLFW_KEY_6] && !keyPressed[GLFW_KEY_6])
	{
		giroAlas = 45.0f;
		printf("giroAlas es: %f\n", giroAlas);

		keyPressed[GLFW_KEY_6] = true;
	}
	if (!keys[GLFW_KEY_6])
	{
		keyPressed[GLFW_KEY_6] = false;
	}

	if (keys[GLFW_KEY_7] && !keyPressed[GLFW_KEY_7])
	{
		giroAlas = 0.0f;
		printf("giroAlas es: %f\n", giroAlas);
